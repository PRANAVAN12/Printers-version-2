                    ...
                    <ul class="dropdown" name="notificationMenu">
                      <li class="notification-group">
                        ...
                        <?php
							...
							$query="select orders.*,users.UserName from orders INNER JOIN users ON users.id=orders.user_id where users.UserName=\"".$_SESSION['UserName']."\";";
                            ...
                            while($res = mysqli_fetch_array($result)) {
                              echo "<a href=\"./Orders/UserOrder.php?id=".$res['id']."\">";
                              ?>
